jQuery(function () {
    ...
    function addFile(file) {
        ...
        var $li = $('<li data-key="' + file.key + '" data-src="' + file.src + '" data-sort="' + index + '" id="' + file.id + '" style="position:absolute;cursor:move;width:' + thumbnailWidth + 'px;height:' + thumbnailHeight + 'px;left:' + imgLeft + 'px;top:' + imgTop + 'px">' +
            ...
            '<p class="imgWrap"></p>' +
            '<input class="hidImg" type="hidden" value="' + file.src + '" />' +
            //'<input class="hidImgRemark" type="hidden" value="' + file.remark + '" />' +
            '</li>'
        ),
            ...
            //$imgRemark = $('<div class="remark" title="' + file.remark + '">' + file.remark + '</div>').appendTo($li),
    ...
    window.fileQueue=function fileQueue(file) {
