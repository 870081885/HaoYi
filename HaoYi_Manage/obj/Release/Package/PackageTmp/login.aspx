<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="HaoYi_Manage.login" %>
...
<head>
	<meta charset="utf-8" />
	<title>HaoYi Shop管理系统</title>
    <meta name="author" content="HaoYi Shop">
    <meta name="keywords" content="HaoYi Shop" />
    <meta name="description" content="HaoYi Shop" />
	...
	<div id="page-container" class="fade">
        ...
        <div class="login bg-black animated fadeInDown">
            ...
            <div class="login-header">
                <div class="brand">
                    <span class="logo"></span>HaoYi Shop
                    <small>HaoYi Shop管理系统</small>
                </div>
                <div class="icon">
        ...
        <!-- end login -->     
        <div style="padding: 30px 0;line-height: 30px;color: #666;font-size:15px;position:fixed;bottom:0;left:40%;">
             © 2017 梦影雾花 - HaoYi Shop框架
            <a href="http://www.miitbeian.gov.cn/state/outPortal/loginPortal.action" target="_blank">沪ICP备17041920号-1</a>                
        </div>
	</div>
	<!-- end page container -->
