<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userAdd.aspx.cs" Inherits="HaoYi_Manage.system.userAdd" %>
...
<body>
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-4">
            <h2 class="sTitle">新增用户</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="#">系统管理</a>
                </li>
                <li class="active">
                    <strong class="sTitle">新增用户</strong>
                </li>
            </ol>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function getUserType() {
        $.ajax({
            ...
            data: { action: "selectList", key: "roleName", value: "id", tableName: "system_role" },
            async: false,
