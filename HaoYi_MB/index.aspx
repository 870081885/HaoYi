<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="HaoYi_MB.index" %>
...
<head>
    ...
    <%--滑动导航--%>
    <link href="assets/mi/css/index/slickSlider.css" rel="stylesheet" />
    <%--头部--%>
    <link href="assets/mi/css/index/indexHeader.css" rel="stylesheet" />
    <%--底部--%>
    <link href="assets/mi/css/footer.css" rel="stylesheet" />
    <%--滚动到最上面--%>
    <link href="assets/mi/css/index/goTop.css" rel="stylesheet" />
    <%--列表--%>
    <link href="assets/mi/css/index/list.css" rel="stylesheet" />   
    <%--公共--%>
            ...
            <div class="top-header">
                <div class="index-header">
                    ...
                    <div class="search_bar">
                        <a href="/search.aspx"><span class="text">搜索商品名称</span></a>
                    </div>
                    <div class="login">
            ...
            <div class="main-container">
                <%--                <div class="swipe-tabs-container slick-slider slick-initialized">
                    <div aria-live="polite" class="slick-list">
                            <div class="slick-track">--%>
                <!--6块导航-->
                <div id="divContent" aria-hidden="false">
                    <%--<div id="divContent" class="swipe-tab-content slick-slide slick-c slick-current slick-active" data-slick-index="0" aria-hidden="false">--%>
                    <!--幻灯片开始-->
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="javascript:void(0);" title="黄昏">
                                    <img src="assets/mi/images/banner1.jpg" class="img-responsive" alt="黄昏" style="display: block; width: 100%;">
                                </a>
                            </div>                        
                        </div>
                                ...
                                <div class="list_two_type1">
                                    <div class="box">
                                        <div class="item J_linksign-customize">
                                            <a class="exposure" href="/content.aspx">
                                                <div class="img">
                ...
                <%--                            <div data-channel="1864" class="swipe-tab-content slick-slide" data-slick-index="1" aria-hidden="true" style="width: 400px;">
                            ...
                            <div data-channel="1865" class="swipe-tab-content slick-slide" data-slick-index="4" aria-hidden="true" style="width: 400px;">
                                <div class="slider" id="slider1865" style="height: 3.6rem">
                                    <div class="swipe-wrap">
                                        <div>
                                            <a class="exposure"><span class="imgurl">
                            ...
                            <div data-channel="1861" class="swipe-tab-content slick-slide" data-slick-index="5" aria-hidden="true" style="width: 400px;">
                                <div class="slider" id="slider1861" style="height: 3.6rem; visibility: visible;">
                                    <div class="swipe-wrap" style="width: 400px;">
                                        <div style="width: 400px; left: 0px; transition-duration: 0ms; transform: translate(0px, 0px) translateZ(0px);">
                                            <a class="exposure"><span class="imgurl">
                                            ...
                                            <div class="list_two_type1">
                                                <div class="box">
                                                    ...
                                                    <div class="item J_linksign-customize">
                                                        <a class="exposure">
                                                            <div class="img">
                                                                <img class="big lazy"><!--vue-if--><!--vue-if-->
                                                            </div>
                                                            <div class="info">
...
<script src="assets/js/moveline.js"></script>
...
<script>
    $(function () {
        ...
        $("#divContent").css("width", $(document.body).width());
    });
