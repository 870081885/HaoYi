<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="content.aspx.cs" Inherits="HaoYi_MB.content" %>
...
<head>
    ...
    <%--头部分享后退--%>
    <link href="assets/mi/css/content/fixed-header.css" rel="stylesheet" />
    <%--产品内容--%>
    <link href="assets/mi/css/content/product.css" rel="stylesheet" />
    <%--提示--%>
    <link href="assets/mi/css/content/prompt-box.css" rel="stylesheet" />
    <%--推荐列表--%>
    <link href="assets/mi/css/content/list-recommend.css" rel="stylesheet" />
    <%--公共--%>
    <link href="assets/mi/css/public.css" rel="stylesheet" />

    <%--<link href="assets/mi/css/content/StyleSheet2.css" rel="stylesheet" />--%>
    <%--<link href="assets/mi/css/content/StyleSheet5.css" rel="stylesheet" />--%>
    <%--<link href="assets/mi/css/content/StyleSheet7.css" rel="stylesheet" />--%>
    <%--<link href="assets/mi/css/content/StyleSheet8.css" rel="stylesheet" />--%>
        ...
        <div class="page-product-view" data-log="商品详情">
            <div class="bt_mask">
                <div class="bt_panel">
                    <p class="tit"></p>
                    <p class="tips"></p>
                    <img src="assets/mi/images/close.png" class="bt_close">
                </div>
            </div>
            <div class="product-view">
                <div class="fixed-header">
                    <div class="left">
                        <a title="小米商城" data-log="HEAD-首页" class="home" data-stat-id="39235ac2dc88b00a">
                            <img src="assets/mi/images/icon_back_n.png" style="display: none" class="bgcicon ib">
                            <img src="assets/mi/images/back.png" class="bgcicon2 ib">
                        </a>
                    </div>
                    <div class="tit">
                    </div>
                    <div class="right">
                        <a>
                            ...
                            <img src="assets/mi/images/share.png" class="search ib">
                        </a>
                    </div>
                ...
                <div id="slider" class="slider" style="visibility: visible;">
                    <div class="swipe-wrap" style="width: 1280px;">
                        <!--vue-if-->
                        <div data-index="0" style="width: 7.29rem; left: 0px; transition-duration: 0ms; transform: translate(0px, 0px) translateZ(0px);">
                            <a>
                                <span class="imgurl">
                                    <img src="assets/mi/images/banner.jpg" />
                                </span>
                            </a>
                        </div>
                    </div>
                    <div class="swipe-nav ui-box">
                        <!--vue-if-->
                        <span class="ui-box-flex on">&nbsp;</span><span class="ui-box-flex">&nbsp;</span><span class="ui-box-flex">&nbsp;</span><span class="ui-box-flex">&nbsp;</span><!--v-repeat-gallery_img-->
                    </div>
                    <!--vue-if-->
                </div>
                <!--vue-if-->
                ...
                <div class="liveView J_linksign-customize bb" style="display: none;">
                    <div class="ui-box">
                        <div class="live-left ui-box-flex">
                            ...
                            <p class="p2"></p>
                            <div class="picon">
                                <img src="assets/mi/images/live.png" class="icon">
                            </div>
                        </div>
                ...
                <div class="attrsQaView J_linksign-customize bb">
                    ...
                    <div class="div more" style="display: none;">
                        <p class="has">请选择版本</p>
                    </div>
                </div>
                ...
                <div class="descdescdesc J_linksign-customize bb">
                    <div class="flex-row-left" data-stat-id="1729ae1b8b081dea">
                        <div style="visibility: hidden" class="mr4x max-width2 has">送至</div>
                        <div class="ui-box-flex flex-row-left">
                            <img src="assets/mi/images/icon_dui.png" class="img-icon mr1x"><img src="assets/mi/images/icon_tan.png" class="img-icon mr1x" style="display: none;"><p class="fsc1">支持7天无理由退货</p>
                        </div>
                    </div>
                </div>
                <!--vue-if-->
                ...
                <%--<div class="commentView">
                    <a href="https://m.mi.com/#/comment/index/?product_id=10000029">
                            ...
                            <div class="comment-list">
                                <div class="page">
                                    <div class="item">
                                        <div class="user">
                                            <div class="img">
                                                <img src="assets/mi/images/back.png">
                                            </div>
...
世宁清静验如然，感谢您对小米的支持。
                ...
                <div class="descTabsView">
                    <a id="anchor" name="tabsAnchor"></a>
                    <ul id="tabs" class="tabs flex-row">
                        <li class="tab on"><a>概述</a></li>
                        <li class="tab"><a>参数</a></li>
                        <li class="tab"><a>意外险</a></li>
                            ...
                            <ul>
                                <li>
                                    <div style="display: none;">
                                        <div class="img">
                                            <img class="lazy" data-original="//i8.mifile.cn/v1/a1/43e08d8c-aec3-4ef6-7a4d-d48431640840!540x540.jpg">
                                        </div>
                                        <!--vue-if-->
                                        <!--vue-if-->
                                    </div>
                                ...
                                <li>
                                    <div style="display: none;">
                                        <div class="img">
                                            <img class="lazy" data-original="//i8.mifile.cn/v1/a1/2ad5f523-d067-17b5-8711-fe13ba27d7f0!540x540.jpg">
                                        </div>
                                        <!--vue-if-->
                                        <!--vue-if-->
                                    </div>
                        ...
                        <div class="views" style="display: none;">
                            <ul>
                                <li>
                                    <div style="display: none;">
                                        <div class="img">
                                            <img class="lazy" data-original="//i8.mifile.cn/v1/a1/dff45872-7dc7-4110-c545-5abde13ab6c4!540x540.jpg">
                                        </div>
                                    </div>
                                    <!--vue-if-->
                                </li>
                                <li>
                                    <div style="display: none;">
                                        <div class="img">
                                            <img class="lazy" data-original="//i8.mifile.cn/v1/a1/58d6bea8-2c45-8b5d-c092-90a56485bd78!540x540.jpg">
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <div class="views" style="display: none;">
                            <ul>
                                <li>
                                    <div>
                                        <div class="img">
                                            <img class="lazy" data-original="//i8.mifile.cn/v1/a1/5e229e5e-a9b4-99e5-d74b-7b3a9e745211!540x540.png">
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <a class="showAllBtn">查看全部图文详情 &gt;</a><!--vue-if-->
                    </div>
                </div>
                                ...
                                <ul>
                                    <li class="J_linksign-customize">
                                        <a class="exposure" href="#">
                                            <div class="img">
                                                <img class="lazy" src="assets/mi/images/img2.jpg" />
                                            </div>
                ...
                <div class="product-footer ui-box">
                    <a href="https://m.mi.com/#/index" class="br">
                        <div class="home icon-home"></div>
                        <div class="p">首页</div>
                    </a><a href="https://m.mi.com/#/cart/index">
