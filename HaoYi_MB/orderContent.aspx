<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderContent.aspx.cs" Inherits="HaoYi_MB.orderContent" %>

<!DOCTYPE html>
<!-- saved from url=(0061)https://m.mi.com/#/order/view?order_id=1150925131251232&type= -->
...
<head>
    ...
    <script type="text/javascript" async="" src="./小米商城-小米官方网站，小米手机、红米手机正品专卖_files/jquery.statData.min.js.下载"></script>
    <script type="text/javascript" async="" src="./小米商城-小米官方网站，小米手机、红米手机正品专卖_files/mstr.js(14).下载"></script>
    <script type="text/javascript" async="" src="./小米商城-小米官方网站，小米手机、红米手机正品专卖_files/jquery.statData.min.js.下载"></script>
    ...
    <div id="wrapper">
        <div class="page-order-view" data-log="订单详情">
            <div class="header">
                ...
                <div class="tit">
                    <h2 data-log="HEAD-标题-订单详情"><span class="title">订单详情</span></h2>
                    <!--vue-if-->
                </div>
            ...
            <div class="page-order-view-wrap">
                ...
                <div>
                    <div class="sub-order">
                        <div class="b1">
                            <div class="b11">
                                <p><strong>发货单号：</strong><span>115092513125123201</span></p>
                            </div>
                            <div class="b11">
                                <p><strong>订单状态：</strong><span>已收货</span></p>
                                <a class="btnAftersale" href="https://m.mi.com/#/aftersale/apply/?ssid=115092513125123201" data-stat-id="a4128c4d340b1d51" onclick="_msq.push([&#39;trackEvent&#39;, &#39;aa6b36fbc8a2bd55-a4128c4d340b1d51&#39;, &#39;/#/aftersale/apply/ssid=115092513125123201&#39;, &#39;pcpid&#39;, &#39;&#39;]);">申请售后</a><!--vue-if--></div>
                            <div class="b12">
                                <ul>
                                    <li class="done">
                                        <div class="mark">
                                    ...
                                    <li class="done">
                                        ...
                                        <div class="time">
                                            <p>2015/09/26 19:04</p>
                                        </div>
                                        <!--vue-if-->
                                    </li>
                                    <!--v-repeat-order_status_info.trace-->
                                </ul>
                            </div>
                        </div>
                        <div class="b8">
                            <div class="b81">
                                <p><strong>物流信息：</strong><span>EMS(郑州)</span><span>1112635267906</span><!--vue-if--></p>
                            </div>
                            <!--vue-if-->
                            <!--vue-if-->
                        </div>
                                ...
                                <li>
                                    <div class="ui-box">
                                        ...
                                        <div class="ui-box-flex">
                                            ...
                                            <div class="price">
                                                <p><strong>99元</strong><span>售价：</span><span>99元</span><span>x1</span></p>
                                            </div>
                                            <!--vue-if-->
                                            <!--vue-if-->
                                            <!--vue-if-->
                    ...
                    <div class="sub-order">
                        <div class="b1">
                            <div class="b11">
                                <p><strong>发货单号：</strong><span>115092513125123202</span></p>
                            </div>
                            <div class="b11">
                                <p><strong>订单状态：</strong><span>已收货</span></p>
                                <a class="btnAftersale" href="https://m.mi.com/#/aftersale/apply/?ssid=115092513125123202" data-stat-id="21726155c221a1a0" onclick="_msq.push([&#39;trackEvent&#39;, &#39;aa6b36fbc8a2bd55-21726155c221a1a0&#39;, &#39;/#/aftersale/apply/ssid=115092513125123202&#39;, &#39;pcpid&#39;, &#39;&#39;]);">申请售后</a><!--vue-if--></div>
                            <div class="b12">
                                <ul>
                                    <li class="done">
                                        <div class="mark">
                        ...
                        <div class="b8">
                            <div class="b81">
                                <p><strong>物流信息：</strong><span>EMS(郑州)</span><span>1112635268206</span><!--vue-if--></p>
                            </div>
                            <!--vue-if-->
                            <!--vue-if-->
                        </div>
                                ...
                                <li>
                                    <div class="ui-box">
                                        ...
                                        <div class="ui-box-flex">
                                            ...
                                            <div class="price">
                                                <p><strong>19元</strong><span>售价：</span><span>19元</span><span>x1</span></p>
                                            </div>
                                            <!--vue-if-->
                                            <!--vue-if-->
                                            <!--vue-if-->
                                ...
                                <li>
                                    <div class="ui-box">
                                        ...
                                        <div class="ui-box-flex">
                                            ...
                                            <div class="price">
                                                <p><strong>1元</strong><span>售价：</span><span>1元</span><span>x1</span></p>
                                            </div>
                                            <!--vue-if-->
                                            <!--vue-if-->
                                            <!--vue-if-->
                                ...
                                <li>
                                    <div class="ui-box">
                                        ...
                                        <div class="ui-box-flex">
                                            ...
                                            <div class="price">
                                                <p><strong>69元</strong><span>售价：</span><span>69元</span><span>x1</span></p>
                                            </div>
                                            <!--vue-if-->
                                            <!--vue-if-->
                                            <!--vue-if-->
                                ...
                                <li>
                                    <div class="ui-box">
                                        ...
                                        <div class="ui-box-flex">
                                            ...
                                            <div class="price">
                                                <p><strong>9.9元</strong><span>售价：</span><span>9.9元</span><span>x1</span></p>
                                            </div>
                                            <!--vue-if-->
                                            <!--vue-if-->
                                            <!--vue-if-->
                ...
                <div>
                    <div class="b4">
                        <ul>
                            <li><strong>下单日期：</strong><span>2015/09/25 09:32</span></li>
                            <li class="address">
                                <div><strong>收货地址：</strong></div>
                                <div class="info"><span>河南</span><span>南阳市</span><span>西峡县</span><span>滨河锦园五号楼第一单元1楼右侧</span></div>
                            </li>
                            <li><strong>收货人名：</strong><span>袁小帅 </span><span class="tel">182****1692</span></li>
                            <!--vue-if-->
                            <li><strong>收货时间：</strong><span>不限送货时间</span></li>
                            <li><strong>发票类型：</strong><span>电子发票</span></li>
                            <!--vue-if-->
                    ...
                    <div class="b9">
                        <div class="h1">下载小米商城客户端后可以查看电子发票</div>
                        <a href="http://m.mi.com/p?fallback=http%3A%2F%2Fs1.mi.com%2Fm%2Fappdownload%2F%3Fmfull_ad" data-stat-id="720518d54a346316" onclick="_msq.push([&#39;trackEvent&#39;, &#39;aa6b36fbc8a2bd55-720518d54a346316&#39;, &#39;http://m.mi.com/pfallback=http3A2F2Fs1.mi.com2Fm2Fappdownload2F3Fmfull_ad&#39;, &#39;pcpid&#39;, &#39;&#39;]);">
                            <div class="ui-input-btn">下载小米商城客户端</div>
                        </a></div>
                    <!--vue-if-->
                    <!--vue-if-->
                    <!--vue-if-->
                    <div class="b5">
                        <div class="b51">
                            <p><strong>商品价格：</strong><strong>197.9元</strong></p>
                        </div>
                        <!--vue-if-->
                        <div class="b51">
                            <p><strong>配送费用：</strong><strong>15元</strong></p>
                        </div>
                        <div class="b52">
                            <p><strong>应付总额：</strong><strong>212.9元</strong></p>
                        </div>
                        <!--vue-if-->
                    </div>
                    <!--vue-if-->
